...
import { useVue, useApiFactory, useAppFlow, useProducts } from '../composables';
import { AdminModel, UserModel, Product, getUnderwritingColor, getUnderwritingIcon, ResultModel } from '../models';

export default defineComponent({
    components: {
        Loading: () => import("../components/Loading.vue"),
        AdminDetails: () => import("../components/userCreate/Admin.vue"),
        AccountDetails: () => import("../components/userCreate/Account.vue"),
        SignUpComplete: () => import("../components/userCreate/Result.vue")
    },
    ...
    setup(_props, context) {
        ...
        const adminModel = ref<AdminModel>({
            username: "",
            password: ""
        });

        const policyLocator = ref<string>();
        ...
        const resultModel = ref<ResultModel>({
            userResult: {
                createdTimestamp: '',
                username: '',
                name: '',
